...
public class NlpirTest {
	...
	public void testFileProcess(){
		double flag = NlpirMethod.NLPIR_FileProcess("./test/十八大报告.TXT", "./result/result.txt", 1);
	...
	public void testFileKeyWords(){
		String result = NlpirMethod.NLPIR_GetFileKeyWords("./Test/Nlpir/source.txt", 100, true);
	...
	public void testFileNewWords(){
		...
		System.out.println("测试文本路径新词(有时文本太短，没有新词):");
		System.out.println(result);
	}
	...
	public void testAddUserWord(){
		int flag1 = NlpirMethod.NLPIR_AddUserWord("俄罗斯卫星网 user");
