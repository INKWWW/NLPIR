package classify.classifier;

import classify.fileutil.OSinfo;
...
public interface ClassifierLibrary extends Library {
	...
	ClassifierLibrary Instance = (ClassifierLibrary) Native.loadLibrary(OSinfo.getSysAndBit("LJClassifier"),
